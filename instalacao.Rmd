...
Para as atividades do curso, acessem o espaço de trabalho compartilhado do RStudio Cloud [aqui](https://rstudio.cloud/project/2759021).
...
O código `r icons::fontawesome("code", style = "solid")` usado no encontro pode ser baixado [aqui](https://drive.google.com/file/d/1EuGsbYtyJjbTeDg1i9y13XGf534umONl/view?usp=sharing).

Já o vídeo `r icons::fontawesome("video", style = "solid")` pode ser acessado [aqui](https://drive.google.com/file/d/13LAkrL4W4cAGU3lcgwlAzpdOAgCdpSUU/view?usp=sharing).
