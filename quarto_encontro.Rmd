...
O código `r icons::fontawesome("code", style = "solid")` usado no encontro pode ser baixado aqui, mas recomendo que acessem o material pelo [Rstudio Cloud](https://rstudio.cloud/project/2759021), como nos encontros anteriores.
